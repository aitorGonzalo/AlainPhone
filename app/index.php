...
<body>
    <div>
        <nav>
            <ul>
                ...
                <img src="AlainsPhone.png" class=logo>
    ...
    <div class=" botones">
        ...
        <input class="boton" type="button" value="Ver moviles de segunda mano" name="ver.moviles" onclick="location='lista.php'">
        <input class="boton" type="button" value="Añadir movil de segunda mano" name="añadirmovil" onclick="location.href='movilform.php'">
